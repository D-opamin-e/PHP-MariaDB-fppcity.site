...
<html>
  <head>
    ...
    <link rel="stylesheet" href="SQ/ban_user_notice/assets/login_m_hurts.css?r=2"/>
  ...
  <section class="hurts_login">
        <div class="container">
            ...
            <div class="input-group mb-3 login_max_width">
              <button type="submit" class="hurts_btn btn-outline-dark">로그인 <i class="fas fa-angle-right"></i></button> 
            </div>
            </form>     
        </div>
    </section>
            ...
            <!-- <center><a href = "https://dopamine.gq/user/signup.php">     일반 회원가입 </center> -->

    

    <footer class="hurts_footer">
        <div class="container">
          <ab>Dopamine 2020 (C) 모든 권한 보유.</ab>  
        </div>
      </footer>
  </body>
</html> 